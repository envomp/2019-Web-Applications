...
if (isset($_POST['login-submitted'])) {
    ...
    if (!$user) {
        $ERRORS[] = "Email or username is a required field.";
    }
    if (!$password) {
...
?>
    ...
    <div class="form-wrapper box">
        ...
        <form id="login-form" name="login-form" method="post">
            <div class="input-wrapper">
                <label for="login-user" class="input-required">Email or username</label>
    ...
    <div class="box">
        <div><a class="register-ref" href="register.php">Register</a></div>
    </div>
