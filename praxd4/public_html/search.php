...
?>
    ...
    <div class="box">
        ...
        $count_query = "SELECT COUNT(*) AS `num_results` FROM `users_185787_envomp`
        ...
        <?php
        if ($user_query == "*") {
            $query = "SELECT * FROM `users_185787_envomp` LIMIT " . (($current_page) * RESULTS_PER_PAGE) . ", " . RESULTS_PER_PAGE;
        } else {
