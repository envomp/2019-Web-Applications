...
$JS_FILES[] = "js/comment-post.js";
$JS_FILES[] = "js/post-post.js";
...
?>
    ...
    <div class="box">
        ...
        if ($user['photo']) {
            ...
            echo "<img src=\"" . SITE_ROOT . "/images/profile/" . $user['user_id'] . ".png\" width=\"200px\" height=\"auto\" />\n";
            echo "</div>\n";
        }
        ?>
    ...
    <div class="box">
        ...
        switch ($ACTION) {
            case "posts":
                ...
                break;
            case "following":
                $num_items = $num_following;
                break;
            case "followers":
                $num_items = $num_followers;
                break;
        }
